...
class Configuration extends Base
{
    ...
    {
        Event::fire('framework.configuration.initialize.before', [$this->_type, $this->_options]);

        if (!$this->_type) {
            throw new Exception\Argument('Invalid type');
        }

        Event::fire('framework.configuration.initialize.after', [$this->_type, $this->_options]);
