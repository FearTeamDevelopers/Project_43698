...
class HTMLPurifier_DoctypeRegistry
{
     ...
     */
    public function register($doctype, $xml = true, $modules = [],
        $tidy_modules = [], $aliases = [], $dtd_public = null, $dtd_system = null
    ) {
        if (!is_array($modules)) $modules = [$modules];
        if (!is_array($tidy_modules)) $tidy_modules = [$tidy_modules];
