...
class IDS_Log_File implements IDS_Log_Interface
{
    ...
    protected function prepareData($data)
    {
        ...
        $dataString = sprintf($format, urlencode($this->ip), date('c'), $data->getImpact(), join(' ', $data->getTags()), urlencode(trim($attackedParameters)), urlencode($_SERVER['REQUEST_URI']), $_SERVER['SERVER_ADDR']
        );
     ...
     * @return boolean
     */
    public function execute(IDS\Report $data)
    {
