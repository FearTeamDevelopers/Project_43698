 ...
 * @author Tomy
 */
class Report extends AbstractSource
{

    protected $model = 'App\Model\ReportModel';
    protected $pathPrefix = '/reportaze/r/';
    protected $table = 'report';
    protected $alias = 'Reportáž';
    ...
    public function buildIndex($complete = false, $runByUser = false)
    {
        ...
        try {
            ...
            $articles = \App\Model\ReportModel::all(['active' => true, 'approved' => true]);
            $wordsCount = 0;

            if (null !== $articles) {
                /* @var $article \App\Model\ReportModel */
